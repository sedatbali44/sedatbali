CREATE OR REPLACE PROCEDURE SOS_TABS.SOS_MAIL_GRUP_TNM_MAIL_TRG_SOZLU
IS
...
SELECT * FROM SOS_MAIL_GRUP_TNM sos
 ...
 WHERE ser.ISLEM_KODU ='SOZLUSKYT' AND  sos.MAILS  IS NOT NULL;

crm cur_email%ROWTYPE;

BEGIN
  SELECT MES_CODE,MES_EXPLANATION INTO m_subj,m_body FROM SOS_MES_DEF  WHERE MES_CODE =  'SOZLU_KAYIT_MES_SUBJECT' OR MES_CODE = 'SOZLU_KAYIT_MES';
...
END SOS_MAIL_GRUP_TNM_MAIL_TRG_SOZLU;